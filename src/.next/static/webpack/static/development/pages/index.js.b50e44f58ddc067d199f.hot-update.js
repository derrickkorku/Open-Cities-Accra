  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      this.state.render && map.on("load", function () {
        ...
        map.on('click', 'states-layers', function (e) {
          new mapboxgl.Popup().setLngLat(e.lngLat).setHTML("<h4>Hello World</h4>").addTo(map);
...
//# sourceMappingURL=index.js.b50e44f58ddc067d199f.hot-update.js.map