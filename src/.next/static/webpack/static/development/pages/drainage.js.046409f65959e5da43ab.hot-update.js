        ...
        onChange: function onChange(e) {
          if (e.target.value === "Akweteyman") {
            _this2.setState({
              ...
              waterway: "akweteyman_waterways.geojson"
            });

            window.alert(_this2.state.community);
          } else {
            if (e.target.value === "Alogboshie") {
              _this2.setState({
                community: e.target.value,
                waterway: "alogboshie_waterways.geojson"
              });
...
//# sourceMappingURL=drainage.js.046409f65959e5da43ab.hot-update.js.map