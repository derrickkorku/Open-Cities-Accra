    ...
    value: function render() {
      ...
      this.state.render && map.on("load", function () {
        ...
        map.addLayer({
          ...
          'paint': {
            'circle-color': ['match', ['get', 'flood_history.flood_depth'], 'Keen_deep_(30-50CM)', '#088', 'Chest_deep_(1-1.5M)', 'Person_height_(1.5-2M)Color', 'Waist_deep_(60cm-1m)', 'pink', 'Person_height_(1.5-2M)', 'purple', "school", "yellow",
            /* other */
            'gray'],
            'circle-radius': 10
          }
...
//# sourceMappingURL=flood-history.js.92aae71946ea691874c2.hot-update.js.map