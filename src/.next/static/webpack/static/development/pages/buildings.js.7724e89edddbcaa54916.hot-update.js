    ...
    value: function render() {
      ...
      this.state.render && map.on("load", function () {
        ...
        map.addLayer({
          ...
          'layout': {},
          'paint': {
            'fill-color': ['match', ['get', 'building'], 'residential', '#088', 'commercial', 'red', 'commercial;residential', 'pink',
            /* other */
            'green'],
            'fill-opacity': 0.2
          }
...
//# sourceMappingURL=buildings.js.7724e89edddbcaa54916.hot-update.js.map