    ...
    value: function render() {
      ...
      this.state.render && map.on("load", function () {
        ...
        map.addLayer({
          ...
          'paint': {
            'circle-color': ['match', ['get', 'flood_history.flood_depth'], 'Keen_deep_(30-50CM)', 'rgb(0, 136, 136)', 'Chest_deep_(1-1.5M)', 'rgb(102, 102, 0)', 'Waist_deep_(60cm-1m)', 'pink', 'Person_height_(1.5-2M)', 'purple', "school", "yellow",
            /* other */
            'gray'],
            'circle-radius': 10
          }
...
//# sourceMappingURL=flood-history.js.9fca6bf90dee47646959.hot-update.js.map