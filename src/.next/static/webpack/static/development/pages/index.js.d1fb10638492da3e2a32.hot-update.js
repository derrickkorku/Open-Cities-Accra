...
function (_Component) {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var popup = this.state.render && new mapboxgl.Popup({
        closeOnClick: false
      }).setLngLat([-0.23250, 5.62620]).setHTML('<h1>Hello World!</h1>').addTo(map);
...
//# sourceMappingURL=index.js.d1fb10638492da3e2a32.hot-update.js.map